...
- **When:** 2026-07-12T00:30:23+09:00
- **Target:** plgg guide (deploy-on-merge readiness)
- **Method:** check-all.sh in a fresh detached worktree
- **Status:** pass
- **Observed:** npm-install.sh + check-all.sh exit 0 in a clean checkout of 67f0071c (all package suites green incl. both PoC packages; poc1-search 16 passed, statements 100%); proves the fresh-clone path this branch's CI fix targets

## Deployment Evidence

- **When:** 2026-07-12T00:30:23+09:00
- **Target:** plgg npm packages
- **Method:** publish preflight (PREFLIGHT=1 scripts/publish-npm.sh)
- **Status:** pass
- **Observed:** nothing to publish: no package version bumped past the registry (19 packages already current, @plgg/example private)
