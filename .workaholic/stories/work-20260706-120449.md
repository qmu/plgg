...
- **When:** 2026-07-11T02:26:54+09:00
- **Target:** plgg npm packages
- **Method:** api-probe
- **Status:** pass
- **Observed:** Developer published plgg-cms@0.0.2 via scripts/publish-npm.sh (script gates on green check-all and verifies inline). Agent confirmation: npm view plgg-cms@0.0.2 resolves; scratch consumer npm install (min-release-age overridden) succeeds; import loads with 154 exports.
...
- **Method:** api-probe
- **Status:** pass
- **Observed:** Pre-merge readiness: branch green via the publish run's check-all gate; post-merge promotion check (Deploy Guide workflow + https://plgg.qmu.co.jp/ HTTP 200) to be executed after merge.

## Deployment Evidence

- **When:** 2026-07-11T02:30:21+09:00
- **Target:** plgg guide (post-merge promotion)
- **Method:** api-probe
- **Status:** pass
- **Observed:** Deploy Guide run 29111063118 for merge 1b20edd5 succeeded; https://plgg.qmu.co.jp/ HTTP 200 valid TLS; qmu.github.io/plgg 301-redirects to canonical; retired /packages/plgg-ui route returns 404 as intended.
