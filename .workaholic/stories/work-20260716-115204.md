...
- **When:** 2026-07-16T15:37:36+09:00
- **Target:** plgg guide (deploy-on-merge)
- **Method:** check-all readiness
- **Status:** pass
- **Observed:** Pre-merge readiness: fresh scripts/check-all.sh EXIT 0 on the merged tree (origin/main merged in; all packages rebuilt, all suites and coverage gates green)
...
- **Status:** pass
- **Observed:** PREFLIGHT=1 scripts/publish-npm.sh: nothing to publish - no package version bumped on this branch; new dialect exports reach npm on a later deliberate bump+publish (recorded as a story concern)
