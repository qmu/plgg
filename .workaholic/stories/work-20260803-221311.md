...
- **When:** 2026-08-03T22:33:57+09:00
- **By:** a@qmu.jp
- **Target:** plgg guide (plggpress docs site)
- **Method:** api-probe (post-merge promotion)
- **Status:** pass
- **Observed:** Deploy Guide run 30818308356 succeeded for merge commit 337d511d (build 2m6s, deploy 11s); https://plgg.qmu.co.jp/ returns HTTP 200 with valid TLS and the Guide nav; https://qmu.github.io/plgg/ 301-redirects to it
