...
- **When:** 2026-06-26T12:54:22+09:00
- **Target:** plgg guide (deploy-on-merge, pre-merge readiness)
- **Method:** readiness-proof (scripts/check-all.sh)
- **Status:** pass
- **Observed:** check-all.sh exit 0: all dists built in dependency order; 952 tests passed / 0 failed (plgg 465, plgg-test 86, plgg-view 115, plgg-server 86, plgg-http 32, plgg-router 39, plgg-fetch 27, plgg-sql 25, example 25, plgg-kit 12+6 skipped)
