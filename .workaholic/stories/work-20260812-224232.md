...
- **When:** 2026-08-13T04:40:10+09:00
- **By:** a@qmu.jp
- **Target:** plgg guide (deploy-on-merge readiness)
- **Method:** check-all green on branch + CI check-all
- **Status:** pass
- **Observed:** local ./scripts/check-all.sh exit 0 (127.1s); PR #117 CI check-all pass on ubuntu x64 (runs 31632937038, 31633292379) — @typescript/typescript-linux-x64 resolved on a fresh clone; npm preflight: nothing to publish

## Deployment Evidence

- **When:** 2026-08-13T04:40:10+09:00
- **By:** a@qmu.jp
- **Target:** plgg guide production (post-merge promotion)
- **Method:** Deploy Guide workflow + api-probe
- **Status:** pass
- **Observed:** Deploy Guide run 31633532497 for merge b67532b7 succeeded (gh run watch exit 0); https://plgg.qmu.co.jp/ HTTP 200, TLS verify 0, Guide nav renders; https://qmu.github.io/plgg/ 301 -> https://plgg.qmu.co.jp/; GitHub Release 2026.08.week2.release1 published
