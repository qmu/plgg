...
- **When:** 2026-08-11T19:34:43+09:00
- **By:** a@qmu.jp
- **Target:** plgg guide (plggpress docs site)
- **Method:** api-probe (post-merge promotion)
- **Status:** pass
- **Observed:** Deploy Guide run 31482619340 succeeded for merge commit 34da750a; https://plgg.qmu.co.jp/ returns HTTP 200 with valid TLS and https://qmu.github.io/plgg/ 301-redirects to it. The unit's own objective is confirmed independently: gh api dependabot/alerts reports 0 open alerts, down from the 2 high sharp findings this work existed to retire.
