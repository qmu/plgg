...
- **When:** 2026-07-16T17:59:48+09:00
- **Target:** plgg guide (deploy-on-merge)
- **Method:** check-all readiness
- **Status:** pass
- **Observed:** Pre-merge readiness: fresh scripts/check-all.sh EXIT 0 on this branch (all packages incl. the new plgg-search); gate-readme and vendor-boundary green
