...
- **When:** 2026-08-03T21:29:57+09:00
- **By:** a@qmu.jp
- **Target:** release-scan
- **Method:** override
- **Status:** bypassed
- **Observed:** size findings overridden on the developer's explicit merge instruction: too-many-files (172 files, of which 151 are the incidental concern-corpus rename), too-large-commit 326d44f5 (3441 lines, same migration), too-large-commit 177a82cb (568 lines, the implementation). No secret or leak finding; hard count 0.

## Deployment Evidence

- **When:** 2026-08-03T21:30:19+09:00
- **By:** a@qmu.jp
- **Target:** plgg guide (plggpress docs site)
- **Method:** api-probe
- **Status:** pass
- **Observed:** Pre-merge readiness per the guide deployment contract: scripts/check-all.sh green end to end on this branch (39 checks, exit 0), with catchup-main reporting branch_up_to_date so the proven tree equals what merges.
