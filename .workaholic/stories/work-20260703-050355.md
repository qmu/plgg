...
- **When:** 2026-07-03T17:37:04+09:00
- **Target:** plgg guide (Pages)
- **Method:** api-probe (post-merge promotion)
- **Status:** pass
- **Observed:** Deploy Guide run 28648445586 green (deploy job failed once with a transient 'Deployment failed, try again later' error_count:10, succeeded on --failed re-run). https://plgg.qmu.co.jp/ returns 200 and serves the five-section sidebar Guide/Core/Vocabulary/plggmatic/plggpress with zero per-page 目次; qmu.github.io/plgg 301-redirects to it. GitHub Release 2026.07.week1.release1 published against merge commit 0ddb00d.
