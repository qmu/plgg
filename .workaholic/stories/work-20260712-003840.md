...
- **When:** 2026-07-12T14:16:58+09:00
- **Target:** plgg guide (plggpress docs site)
- **Method:** api-probe (post-merge promotion)
- **Status:** pass
- **Observed:** Deploy Guide run 29180869781 for merge commit a9ff447f completed success; https://plgg.qmu.co.jp/ returns HTTP/2 200 with valid TLS and renders the Guide nav and packages content; https://qmu.github.io/plgg/ 301-redirects to the canonical host. GitHub Release 2026.07.week2.release5 published at the merge commit.
