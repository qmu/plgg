...
- **When:** 2026-06-27T19:52:31+09:00
- **Target:** Deploy Guide -> GitHub Pages (production)
- **Method:** post-merge deploy run + site render check
- **Status:** pass
- **Observed:** Deploy Guide run 28287007152 success on merge commit c63c84c; https://qmu.github.io/plgg/ returns HTTP 200 and renders the guide (title plgg)
