...
- **When:** 2026-07-03T01:54:26+09:00
- **Target:** plgg guide (GitHub Pages)
- **Method:** api-probe (deploy-on-merge: pre-merge readiness)
- **Status:** pass
- **Observed:** Pre-merge readiness proof at HEAD 1dc6392 (code state fa9ab95): fresh check-all.sh exit 0 after each facade commit (all dists rebuilt, all package tests, coverage + README gates); guide build byte-identical to the pre-facade oracle; tsc-plgg.sh clean. Post-merge promotion (Deploy Guide workflow + site probe) to be recorded in .workaholic/deployments/guide.md after merge.
