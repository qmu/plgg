...
- **When:** 2026-07-16T17:57:14+09:00
- **Target:** plgg npm packages
- **Method:** api-probe
- **Status:** pass
- **Observed:** Developer published; verified against the registry: plgg-mcp@0.0.2 (now latest) and plgg-cms@0.0.3 resolve; scratch install of plgg-mcp imports dispatchMcp/runStdioServer, exposes NO contentTools, and its published dist contains zero node:sqlite references - the ticket's property verified on the published artifact
