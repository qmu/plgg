---
type: Feedback
title: (carried from PR #41) plgg-db-migration issues: --to degrade flag, listApplied cause evaluation, and cross-process race on migrateTenant
kind: concern
source: development
...
supersedes:
severity: moderate
concern_id: plgg-db-migration-issues-to-degrade
owner: 
mission: 
tickets: []
origin_pr: 53
