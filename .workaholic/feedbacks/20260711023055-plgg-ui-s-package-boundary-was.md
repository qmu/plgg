---
type: Feedback
title: plgg-ui's package boundary was retired in-repo while an external repo may still depend on the published artifact
kind: concern
source: development
...
supersedes:
severity: moderate
concern_id: plgg-ui-s-package-boundary-was
owner: 
