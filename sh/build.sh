...
echo "=== Running 'npm run build' in src/plgg, src/plgg-kit, src/plgg-view, src/plgg-server, src/plgg-http-client, and src/plgg-sql ==="
...
# plgg-http-client after plgg-server: it consumes the router's dist.
