...
It consumes `plgg`, `plgg-view`, and `plgg-web` as real dependencies (`file:`),
...
import { renderToString, pageResponse } from "plgg-web";  // SSR
import { render } from "plgg-web/client";                 // CSR (browser)
```
