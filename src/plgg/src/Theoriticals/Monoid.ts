 ...
 * };
 */
export interface Monoid1<KindKey extends KindKeys1> extends Semigroup1<KindKey> {
  /**
 ...
 * @template KindKey - The kind identifier for this monoid
 */
export interface Monoid2<KindKey extends KindKeys2> extends Semigroup2<KindKey> {
  /**
 ...
 * @template KindKey - The kind identifier for this monoid
 */
export interface Monoid3<KindKey extends KindKeys3> extends Semigroup3<KindKey> {
  /**
