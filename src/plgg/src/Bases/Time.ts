import { Result, ok, err, InvalidError, isStr, Refinement } from "plgg/index";
...
export const timeRefinement: Refinement<Time> = {
  is: (value: unknown): value is Time => value instanceof Date,
  as: (value: unknown): Result<Time, InvalidError> =>
...
export const { is: isTime, as: asTime } = timeRefinement;
