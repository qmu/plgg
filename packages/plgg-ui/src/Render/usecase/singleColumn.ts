...
import {
  ...
  navPane,
  mainPane,
} from "plgg-ui/Layout/usecase/combinators";
import { heading } from "plgg-ui/Component/usecase/typography";
import { type SchedulerMsg } from "plgg-ui/Schedule/model/Msg";
import {
  type Scene,
  type ActionButton,
  menuLevel$,
...
import {
  ...
  detailFields,
  backControl,
} from "plgg-ui/Render/usecase/parts";
