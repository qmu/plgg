...
.pm-colhead{border-bottom:none;background:var(--pm-text);color:var(--pm-surface);border-radius:8px;margin-bottom:0.6rem;}
...
.pm-menu-body ul{list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:0.4rem;}
.pm-menu-body li a{display:block;border:1px solid var(--pm-border);border-radius:8px;padding:0.5rem 0.65rem;background:var(--pm-surface);color:var(--pm-text);text-decoration:none;}
