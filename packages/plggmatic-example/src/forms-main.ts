...
.fd-note{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:0.5rem 0.75rem;border:1px solid ${cssVarRef("border")};border-radius:8px;margin:0.4rem 0;}
`;
