...
import { type ConversationKind } from "plgg-cms/content/Stakeholder/model/ConversationKind";
import { type ConversationStatus } from "plgg-cms/content/Stakeholder/model/ConversationStatus";
import { type Visibility } from "plgg-cms/content/Stakeholder/model/Visibility";
 ...
 * (a `SoftStr`, not a plgg-auth `Subject`, to keep plgg-cms/content
