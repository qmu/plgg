...
import { type Scheme } from "plgg-cms/ui/Style/model/scheme";
import {
  type SyntaxKind,
  syntaxPalette,
} from "plgg-cms/ui/Style/model/syntax";
import { type HexColor } from "plgg-cms/ui/Style/model/hexColor";
import {
  type ZBand,
  zBandTable,
} from "plgg-cms/ui/Style/model/zIndex";
import { appearanceStorageKey } from "plgg-cms/ui/Style/model/appearance";
 ...
 * no `any`. `plgg-cms/ui` ships {@link defaultTheme} (values =
 ...
 * design language `plgg-cms/ui` shipped before parameterization
