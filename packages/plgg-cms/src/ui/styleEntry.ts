/**
 * The `plgg-cms/ui/style` subpath: the engine's THEME surface.
 * It starts as plgg-view's inline-style utilities and
 * token maps, and plgg-cms/ui's own tokens (color scheme,
 ...
 *
 * plgg-cms/ui's themed color atoms (`bg`, `color`,
 ...
 * `plgg-cms/ui/style` yields the `var(--pm-*)`, scheme-aware
