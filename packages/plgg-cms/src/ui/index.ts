/**
 * plgg-cms/ui — the plgg-family UI engine. The root barrel is
 ...
 * `plgg-cms/ui/style` subpath (see `src/styleEntry.ts`) so
...
export {
  ...
  row as makeRow,
} from "plgg-cms/ui/Declare/model/Row";
export {
  type Path,
  type TypedSource,
  type Source,
...
export {
  ...
  query,
  matchesQuery,
} from "plgg-cms/ui/Declare/model/Query";
export {
  type Verb,
  type Confirm,
  type Action,
...
export {
  ...
  collectionById,
  actionById,
} from "plgg-cms/ui/Declare/model/Collection";
export {
  type MenuEntry,
  type Menu,
  menuEntry,
...
export {
  type Declaration,
  declare,
} from "plgg-cms/ui/Declare/model/Declaration";
...
export {
  ...
  parseUrl,
  toUrl as sceneToUrl,
} from "plgg-cms/ui/Schedule/usecase/codec";
export {
  type Scheduled,
  schedule,
} from "plgg-cms/ui/Schedule/usecase/schedule";
