 ...
 * `aria-current` inverted pill, per-column scroll above
...
export const chromeCss: SoftStr =
  ...
  `.${cssPrefix}-close:hover{background:${colorVar("primary-base")};color:${colorVar("primary-text")};}` +
  ...
  `.${cssPrefix}-crumbs a:hover{background:${colorVar("primary-base")};color:${colorVar("primary-text")};}` +
  ...
  `.${cssPrefix}-pane a[aria-current="page"]{background:${colorVar("primary-base")};color:${colorVar("primary-text")};}` +
