...
// Every class hook the framework emits, plus the helpers
// for naming its custom properties and selectors. A hook
// that is not exported is not a contract: the framework
// renders these into a consumer's DOM, so a consumer that
// styles one imports it here rather than typing a `pm-`
